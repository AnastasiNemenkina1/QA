...
Отсутствие технической документации, без которой нет точного понимания как должна работать SUT, и какое именно поведение системы будет считаться ошибкой.
Реальная система будет отличаться от SUT.
Использование захардкоренных номеров карт может привести к ошибкам в работе реальной системы, т.к. существует множество различных банковских карт (и с 16-значными, и с 12-значными, и с 10-значными номерами).
Использование двух БД может привести к затруднениям и ошибкам.
Интервальная оценка с учётом рисков (в часах)
Создание проекта и запуск SUT-10 часов.
Написание тест-плана - 8 часов.
Написание и прогон автотестов - 120 часов.
Дополнительное время на устранение замечаний - 24 часа.
Подготовка отчетов по итогам тестирования - 12 часов.
Подготовка учетных документов по итогам автоматизации - 8 часов.
План сдачи работ
Автотесты - 12 дней после утверждения плана.
Отчётные документы по итогам тестирования - 4 дня после утверджения автотестов руководителем.
Подготовка отчета по итогам автоматизации - 4 дня после утверждения отчетных документов руководителем.
